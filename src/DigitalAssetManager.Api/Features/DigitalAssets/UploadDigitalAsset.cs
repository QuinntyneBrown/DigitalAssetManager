using DigitalAssetManager.Api.Helpers;
...
namespace DigitalAssetManager.Api.Features
{
    public class UploadDigitalAsset
    {
        ...
        {
            public IDigitalAssetManagerDbContext _context { get; set; }
            public IHttpContextAccessor _httpContextAccessor { get; set; }
            public Handler(IDigitalAssetManagerDbContext context, IHttpContextAccessor httpContextAccessor)
            {
                _context = context;
